...
GWlatex_labels = {"luminosity_distance": r"$d_{L} [Mpc]$",
                  ...
                  "H1_matched_filter_abs_snr": r"$\mathrm{abs}(\rho^{H}_{mf})$",
                  "L1_matched_filter_abs_snr": r"$\mathrm{abs}(\rho^{L}_{mf})$",
                  "V1_matched_filter_abs_snr": r"$\mathrm{abs}(\rho^{V}_{mf})$",
                  "E1_matched_filter_abs_snr": r"$\mathrm{abs}(\rho^{E}_{mf})$",
