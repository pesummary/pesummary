...
def make_imrct_plots(imrct_deviations, samples, webdir=None):
    ...
    fig.savefig(os.path.join(plotdir, base_string.format("deviations_triangle_plot")))
    fig.close()
    ...
    parameters_to_plot = [["final_mass_non_evolved", "final_spin_non_evolved"], ["mass_1", "mass_2"], ["a_1", "a_2"]]
    ...
    for parameters in parameters_to_plot:
        ...
        fig.savefig(os.path.join(plotdir, base_string.format(save_string)))
        fig.close()
