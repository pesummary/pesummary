...
sed -i 's/create-plots = True/create-plots = False/' ./GW150914.ini
...
summarypages --webdir ./outdir_GW150914/webpage --samples ./outdir_GW150914/result/GW150914_data0_1126259462-4_analysis_H1L1_dynesty_merge_result.json --gw --disable_expert --disable_interactive --no_ligo_skymap
