...
class TestPrecessingSNR(object):
    ...
    def test_precessing_snr(self):
        ...
        np.testing.assert_almost_equal(
            rho_p, [
                0.68388587, 4.44970478, 1.50271423, 16.38278551, 8.36573961,
                10.76045275, 5.56389142, 38.75092545, 19.04936648,
                46.08235298, 11.04476225, 22.15809274, 21.83931449,
                0.52940244, 18.51671749, 60.36654189, 20.90566175, 7.59963947,
                28.81494433, 4.80448464
            ]
        )
...
class TestMultipoleSNR(TestPrecessingSNR):
    ...
    def test_multipole_snr(self):
        ...
        np.testing.assert_almost_equal(
            rho[0], [
                0.65751988, 2.1414448, 1.92966995, 1.36583827, 0.91202824,
                3.76485092, 7.65392604, 1.16167184, 10.25460489, 9.33561953,
                0.21747679, 4.44893768, 1.4904289, 4.70318423, 2.76921055,
                1.90083035, 3.42330456, 1.12028809, 15.47861815, 0.15595173]
        )
        np.testing.assert_almost_equal(
            rho[1], [
                2.20813922, 5.19271057, 7.4048816, 3.81037071, 1.62958146,
                4.28125682, 22.54228317, 14.46282899, 21.05195085, 26.81466547,
                2.33247145, 11.60509714, 6.4064751, 16.00204021, 6.21510341,
                14.83850082, 12.07577107, 0.7150659, 14.36457899, 3.02642992
            ]
        )
        np.testing.assert_almost_equal(
            rho[2], [
                0.18102321, 2.20770255, 0.93261726, 1.7573492, 4.60563054,
                3.2601658, 9.10279199, 13.04963478, 9.7026812, 15.3289052,
                1.58697352, 5.36571405, 8.15103903, 4.51177119, 4.90159264,
                11.23723456, 4.3787358, 1.02301209, 7.38082088, 9.24657289
            ]
        )
