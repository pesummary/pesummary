...
for ifo in H-H1 L-L1 V-V1; do
    ...
    curl -sSLO https://dcc.ligo.org/public/0146/P1700349/001/${file}
done


version=`python -c "import pycbc; print(pycbc.__version__)"`
curl -sSLO https://raw.githubusercontent.com/gwastro/pycbc/v${version}/examples/inference/single/single.ini
