...
# with
path_to_directory = fetch_open_data("GW190412", unpack=True, read_file=False, delete_on_exit=False, outdir="./")
import glob
...
data = fetch_open_data("GW190412", unpack=True, read_file=True, delete_on_exit=False, outdir="./", path="GW190412.h5")
print(data)
